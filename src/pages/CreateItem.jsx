  ...
  return (
    <>
      <div className="container d-flex mt-5 justify-content-center">
        <h5 className="w-50 text-start mb-4 d-none d-md-block"><b>Create new Item</b></h5>
      </div>
      <div className="container d-flex justify-content-center">
        <Form className="col-md-6 col-12">
          ...
          >
            ...
            <img src={Image} className="img-fluid m-3 w-25" style={{backgroundColor: props.theme.image}} alt=" " />
          ...
          <Form.Group className="mb-3 mt-3" controlId="exampleForm.ControlInput1" >
            ...
            <Form.Control type="name" placeholder="Item Name"  style={{backgroundColor: props.theme.form, border:"none"}}/>
          </Form.Group>
          <Form.Group
            className="mb-3 mt-3"
